...
rm(add_df, check, n_courses_all_hdr, n_courses_hdr)
...
# collapse HDR data so I can join it with the spreadsheet data for reporting on themes
hdr_collapse <- df_hdr %>% 
...
sp_hdr <- full_join(hdr_collapse, df_sp)
